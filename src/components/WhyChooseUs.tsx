...
export default function WhyChooseUs() {
  ...
  const finalItems = whyChooseUsItems && whyChooseUsItems.length > 0 ? whyChooseUsItems : [
    ...
    },
    {
      id: "item-5",
      step: 5,
      title: "২৪/৭ ডেমিকেটেড পিচ-পারফেক্ট কাস্টমার সাপোর্ট",
      badge: "লাইভ কেয়ার",
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8 z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 space-y-5">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/25 text-purple-400 text-xs font-semibold uppercase tracking-wider shadow-[0_0_15px_rgba(168,85,247,0.05)]"
          >
            <HelpCircle className="w-4 h-4 text-purple-400 animate-pulse" />
            <span>{sectionHeadings?.whyUsTitle?.includes("কেন") ? "হোয়াই এভেক্সন" : "Why Avexon"}</span>
          </motion.div>
              ...
              >
                ...
                <div className="absolute left-[24px] md:left-1/2 top-2 -translate-x-1/2 z-20">
                  <motion.div
                    ...
                    className="w-12 h-12 rounded-full bg-[#110522] border-2 border-purple-500/80 shadow-[0_0_15px_rgba(168,85,247,0.35)] hover:shadow-[0_0_20px_rgba(240,70,255,0.6)] flex items-center justify-center text-sm font-sans font-black text-purple-300 select-none cursor-pointer transition-all"
                  >
                    {item.step || (idx + 1)}
                  </motion.div>
                </div>
